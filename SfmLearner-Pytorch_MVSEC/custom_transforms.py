...
class RandomScaleCrop(object):
 ...
 #############Emmanuel Code ##############
        #It is important to note how the parameters of the msvec outdoor sequences differ to
        #that of the kitti RGB sequences. The instrinsics of the outdoor sequence are HW rather
        #than HWC. The outdoor sequences are in grayscale and not RGB  
        #in_h, in_w = images[0].shape #Emmanuel Code
