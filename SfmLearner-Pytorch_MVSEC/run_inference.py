...
def main():
    ...
    #print(test_files) #Emmanuel Code

################# Emmanuel Code ##################
    import cv2
    import os
    #def load_images_from_folder(folder):
    #for folder in tqdm(test_files):
    	#images = []
    ...
    for folder in tqdm(test_files): #file
        #print("Folder name: ", folder) #Emmanuel Code
        #for file in os.listdir(folder):

            #print("File name: ", file) #Emmanuel Code
            #img = imread(os.path.join(folder,file))
            img = imread(folder) #Emmanuel Code
            #print("File: ",file)
        #img = io.imread(file,plugin='matplotlib') #Emmanuel Code
        #img = imread(file,plugin='matplotlib') #Emmanuel Code
            ...
            src =  os.path.realpath(folder)
            #print("src: ",src)
            file_path, file_ext = src.split(".")
            ...
            #output = output_dir/'{}_disp.{}'.format(file_name, file_ext)
            #print("Output: ",output)
            if args.output_disp:
