...
class KittiRawLoader(object):
    def __init__(self,
        ...
        #static_frames_file = dir_path/'static_frames.txt' #Emmanuel Code
        ...
        self.date_list = ['2011_09_26', '2011_09_28', '2011_09_29', '2011_09_30'] #Emmanuel Code
        #self.date_list = ['2011_09_26'] #Emmanuel Code
    ...
    def get_scene_imgs(self, scene_data):
        def construct_sample(scene_data, i, frame_id):
            ...
            #sample = {"img": self.load_image(scene_data, i), "id": frame_id} #Emmanuel Code
