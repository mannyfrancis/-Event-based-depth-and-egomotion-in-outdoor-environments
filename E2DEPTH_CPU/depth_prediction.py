...
from utils.timers import CudaTimer, cuda_timers, Timer, timers
...
class DepthEstimator:
    ...
    def update_reconstruction(self, event_tensor, event_tensor_id, stamp=None):
        ...
        with torch.no_grad():
            ...
            with Timer('Reconstruction'): #Emmanuel Francis
            #with CudaTimer('Reconstruction'):
                with Timer('NumPy (CPU) -> Tensor (GPU)'): #Emmanuel Francis
                ...
                for channel in events_for_each_channel.keys():
                    with Timer('Inference'): #Emmanuel Francis
                    ...
                    with Timer('Tensor (GPU) -> NumPy (CPU)'): #Emmanuel Francis
